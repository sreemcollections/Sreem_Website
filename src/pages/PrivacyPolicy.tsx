  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        <h1 className="text-4xl font-playfair font-bold text-primary mb-4">Privacy Policy</h1>
        ...
        <div className="prose prose-sm max-w-none space-y-6">
          <section>
            ...
            <p className="text-foreground/90 leading-relaxed">
              Welcome to Sreem ("we," "our," or "us"). We are committed to protecting your personal information and your right to privacy. 
              This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website and 
              purchase our handcrafted sarees and jewelry.
            </p>
          </section>
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-foreground mt-4 mb-2">2.1 Personal Information</h3>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-primary mb-3">5. Data Security</h2>
            <p className="text-foreground/90 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-primary mb-3">6. Your Privacy Rights</h2>
            <p className="text-foreground/90 leading-relaxed mb-2">Under Indian law, including the Information Technology Act, 2000, and GDPR (if applicable), you have the right to:</p>
            <ul className="list-disc pl-6 space-y-1 text-foreground/90">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-primary mb-3">7. Cookies and Tracking Technologies</h2>
            <p className="text-foreground/90 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-primary mb-3">9. International Data Transfers</h2>
            <p className="text-foreground/90 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-primary mb-3">10. Changes to This Privacy Policy</h2>
            <p className="text-foreground/90 leading-relaxed">
          ...
          <section>
            ...
            <div className="bg-muted/30 p-4 rounded-lg">
              <p className="text-foreground/90"><strong>Sreem - Authentic Craftsmanship</strong></p>
              <p className="text-foreground/90">Email: privacy@sreem.com</p>
              <p className="text-foreground/90">Phone: +91-XXXX-XXXXXX</p>
              <p className="text-foreground/90">Address: [Your Business Address]</p>
            </div>
          </section>
