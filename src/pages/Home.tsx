      ...
      <section className="relative h-[100svh] overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 h-full flex items-center justify-center text-center">
          <div className="max-w-4xl w-full">
            <Badge variant="secondary" className="mb-4 sm:mb-6 bg-secondary/90 text-secondary-foreground text-xs sm:text-sm px-3 py-1">
              Authentic Indian Craftsmanship
            </Badge>
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-playfair font-bold text-white mb-4 sm:mb-6 animate-fade-in leading-tight px-2">
              Elegance Woven in <span className="text-secondary">Tradition</span>
            </h1>
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-white/90 max-w-2xl mx-auto mb-6 sm:mb-8 animate-fade-in px-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center animate-fade-in px-4">
              <Button asChild size="lg" className="group text-base sm:text-lg px-8 sm:px-10 py-6 sm:py-4 bg-primary hover:bg-primary/90 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 relative overflow-hidden w-full sm:w-auto">
                <Link to="/sarees" className="flex items-center justify-center relative z-10">
              ...
              <Button asChild size="lg" className="group text-base sm:text-lg px-8 sm:px-10 py-6 sm:py-4 bg-secondary hover:bg-secondary/90 text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 backdrop-blur-sm relative overflow-hidden border border-secondary/30 w-full sm:w-auto">
                <Link to="/jewelry" className="flex items-center justify-center relative z-10">
      ...
      <section className="py-10 sm:py-12 md:py-16 bg-muted/30">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-8 sm:mb-10 md:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-playfair font-bold text-foreground mb-3 sm:mb-4 relative px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6 md:gap-8 px-2 sm:px-0">
            ...
            <Link to="/sarees" className="block">
              <Card className="group overflow-hidden hover:shadow-2xl transition-all duration-500 hover:scale-[1.01] md:hover:scale-[1.02] cursor-pointer h-full">
                <CardContent className="p-0 relative">
                  <div className="aspect-[4/3] bg-gradient-to-br from-primary/20 via-primary/15 to-secondary/20 flex items-center justify-center relative overflow-hidden">
                    ...
                    <div className="text-center relative z-10 group-hover:transform group-hover:-translate-y-2 transition-transform duration-300 collection-content-glass rounded-xl md:rounded-2xl p-6 md:p-8 mx-3 md:mx-4">
                      ...
                      <Button size="sm" className="md:size-default bg-primary hover:bg-primary/90 group-hover:scale-105 transition-all duration-300 shadow-md group-hover:shadow-lg text-sm md:text-base px-6 md:px-8 pointer-events-none">
                        Shop Collection
                      </Button>
                    </div>
              ...
              <Card className="group overflow-hidden hover:shadow-2xl transition-all duration-500 hover:scale-[1.01] md:hover:scale-[1.02] cursor-pointer h-full">
                <CardContent className="p-0 relative">
                  ...
                  <div className="text-center relative z-10 group-hover:transform group-hover:-translate-y-2 transition-transform duration-300 collection-content-glass rounded-xl md:rounded-2xl p-6 md:p-8 mx-3 md:mx-4">
                    ...
                    <Button variant="outline" size="sm" className="md:size-default border-primary text-primary hover:bg-primary hover:text-white group-hover:scale-105 transition-all duration-300 shadow-md group-hover:shadow-lg bg-white/20 backdrop-blur-sm text-sm md:text-base px-6 md:px-8 pointer-events-none">
                      Explore Collection
                    </Button>
                  </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <div className="inline-block bg-amber-50 border border-amber-200 rounded-full px-6 py-2 mb-4">
                <span className="text-sm font-medium text-amber-900">Recent Highlights</span>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card className="p-6">
                ...
                <blockquote className="text-muted-foreground mb-4 italic">
                  "Beautiful saree collection. The silk feels very soft and the colors look nice. 
                  Good quality for the price. Will buy again from Sreem."
                </blockquote>
              ...
              <Card className="p-6">
                ...
                <blockquote className="text-muted-foreground mb-4 italic">
                  "The silver jewelry is really pretty. I liked the designs shown on the website. 
                  Good traditional pieces. The website is easy to use."
                </blockquote>
                <div className="text-sm">
              ...
              <Card className="p-6">
                ...
                <blockquote className="text-muted-foreground mb-4 italic">
                  "Nice collection of sarees. I can see many designs and colors to choose from. 
                  The pictures are clear and helpful. Happy with what I found here."
                </blockquote>
                <div className="text-sm">
